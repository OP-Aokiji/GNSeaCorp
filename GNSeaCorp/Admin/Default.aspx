...
<asp:Content ContentPlaceHolderID="cphMenuAdmin" runat="server">
    ...
    <ul class="nav nav-pills nav-stacked custom-nav">
        ...
        <li><a href="<%=Constants.NAVIGATE_DEFAULT_PAGE + Constants.UCSLIDELIST %>"><i class="lnr  lnr-select"></i><span>Slider</span></a></li>
        <li><a href="<%=Constants.NAVIGATE_DEFAULT_PAGE + Constants.UCPRODUCTLIST %>"><i class="lnr lnr-book"></i><span>Product</span></a></li>
        <li><a href="<%=Constants.NAVIGATE_DEFAULT_PAGE + Constants.UCNEWSR %>"><i class="lnr lnr-spell-check"></i><span>News</span></a></li>
        <li><a href="<%=Constants.NAVIGATE_DEFAULT_PAGE + Constants.UCMENUR %>"><i class="lnr lnr-menu"></i><span>Menu</span></a></li>
        <li><a href="<%=Constants.NAVIGATE_DEFAULT_PAGE + Constants.UcChangePassword %>"><i class="lnr lnr-indent-increase"></i><span>Change Paword</span></a></li>
        <li><a href="<%=Constants.NAVIGATE_DEFAULT_PAGE + Constants.UCUSERR %>"><i class="lnr lnr-cog"></i><span>User</span></a></li>
